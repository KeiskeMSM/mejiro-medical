...
<head>
  ...
  <link rel="shortcut icon" href="https://img.icons8.com/emoji/48/000000/cherry-blossom.png" />
	  ...
	  <div class="header-inner">
		<div class="logo">
		  <a class="logo-header" href="/">
			<img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo.png" class="main-logo" alt="PACIFIC MALL DEVELOPMENT" />
			<img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo.png" class="fixed-logo" alt="PACIFIC MALL DEVELOPMENT" />
		  </a>
		</div>
...
<?php if ( is_front_page() ) : ?>
	<section class="section-contents" id="keyvisual">
	  ...
	  <div class="wrapper">
		<h1 class="site-title">For the best treatment.</h1>
